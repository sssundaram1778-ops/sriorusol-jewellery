...
export default function Home() {
  ...
  useEffect(() => {
    fetchActivePledges()
    fetchDashboardStats()
  }, [fetchActivePledges, fetchDashboardStats])
  ...
  return (
    <div className="min-h-screen pb-20 bg-blue-50">
      ...
      <div className="px-4 py-4">
        <div className="bg-white rounded-2xl p-5 shadow-lg shadow-blue-500/10 border border-slate-100">
          ...
          <p className="text-4xl font-bold text-blue-600 mb-5 tabular-nums">
      ...
      <div className="px-4 mb-5">
        <div className="flex gap-3">
          <button 
            ...
            className="flex-1 h-14 rounded-2xl font-semibold text-sm bg-blue-600 hover:bg-blue-700 text-white flex items-center justify-center gap-2 transition-all active:scale-[0.98] shadow-lg shadow-blue-500/30"
          >
          ...
          <button 
            ...
            className="flex-1 h-14 rounded-2xl font-semibold text-sm bg-white text-blue-600 border-2 border-blue-200 hover:bg-blue-50 hover:border-blue-300 flex items-center justify-center gap-2 transition-all active:scale-[0.98]"
          >
        ...
        <div className="flex gap-3 mt-3">
          <button 
            ...
            className="flex-1 h-12 rounded-xl font-medium text-sm bg-blue-50 text-blue-600 border border-blue-100 hover:bg-blue-100 flex items-center justify-center gap-2 transition-all active:scale-[0.98]"
          >
      ...
      <div className="px-4 pb-24">
        ...
        {isLoading ? (
          ...
          <div className="text-center py-16 bg-white rounded-2xl border border-slate-100 shadow-sm">
            ...
            <button 
              onClick={() => navigate('/new')}
              className="px-8 py-3.5 bg-blue-600 hover:bg-blue-700 text-white text-sm font-semibold rounded-xl transition-all shadow-lg shadow-blue-500/30"
            >
